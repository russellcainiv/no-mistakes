...
- **After** the push, it watches CI and auto-fixes failures. On GitHub, GitLab, Azure DevOps, and Gitea/Forgejo it also watches PR mergeability and fixes merge conflicts on the branch.
